...
print('\nDetaljniji izvestaj o klasifikaciji:\n')
print(classification_report(labels, pred, target_names=classes))

import matplotlib.pyplot as plt
import numpy as np

for images, labels in Xval.take(1):  
    ...
    for i in range(len(images)):
        ...
        plt.title(f"Tačno: {classes[true_classes[i]]} | Predikcija: {classes[predicted_classes[i]]}", color=color)
        plt.show()
